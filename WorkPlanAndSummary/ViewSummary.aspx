<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSummary.aspx.cs" Inherits="ViewSummary" %>

<%--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
--%><html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>安阳联通部门工作总结管理</title>
        ...
        <table border="2" width="100%" height="98%" cellpadding="6" cellspacing="0" bgcolor="#F5F5FF"
            ...
            <tr>
                <td class="head" align="center" height="25">
                    <b style="font-size: 18px;">安阳联通部门工作总结管理</b>
                </td>
            </tr>
            <tr>
                <td bgcolor="#F5F5FF" align="center" valign="top">
                    <p style="text-align: center; font-weight: 700; font-size: 14pt;">
                        中国联通安阳市分公司<%=Session["DeptName"] %><%=Request.QueryString["ym"].Replace("-","年")+"月" %>工作总结
                    </p>
