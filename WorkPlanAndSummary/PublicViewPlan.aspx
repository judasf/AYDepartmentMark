<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicViewPlan.aspx.cs" Inherits="PublicViewSummary" %>
            ...
            <tr>
                <td bgcolor="#F5F5FF" align="center" valign="top">
                    <p style="text-align: center; font-weight: 700; font-size: 14pt;">
                        中国联通安阳市分公司<%=dpName %><%=Request.QueryString["ym"].Replace("-","年")+"月" %>工作计划
                    </p>
