<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminAddSummaryInfo.aspx.cs" Inherits="AdminAddSummaryInfo" %>
        ...
        var formSubmit = function () {
            if ($('#form1').form('validate')) {
                $.messager.confirm('询问', '您确定提交该月工作总结？提交后则不能修改！', function (r) {
                    if (r) {
                        var url = '../../service/AdminWorkPlanAndSummary.ashx/AdminSaveWorkSummary';
                        //要post的json数据
                        var postDate = {};
                        //有数据的行编号
                        var rowsNum = 0;
            ...
            <tbody>
                <tr>
                    <td class="head" align="center" height="25">
                        <b style="font-size: 18px;">部门工作总结录入</b>
                    </td>
                </tr>
                <tr>
                                ...
                                <tr align="center">
                                    <td>
                                        ...
                                        <p style="text-align: center; font-weight: 700; font-size: 14pt;">
                                            中国联通安阳市分公司<asp:Literal ID="lblDeptName" runat="server"></asp:Literal><asp:Literal ID="lblMonth" runat="server"></asp:Literal>工作总结
                                        </p>
