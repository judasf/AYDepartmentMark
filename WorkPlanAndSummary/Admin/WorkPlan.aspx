<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkPlan.aspx.cs" Inherits="Admin_WorkPlan" %>
        ...
        <tbody>
            ...
            <tr>
                <td valign="middle" bgcolor="#ced4e8" height="18">
                    &nbsp;&nbsp; <b style="line-height: 18px; font-size: 14px;">工作计划查询：</b>
                    <asp:DropDownList ID="ddlYm" runat="server">
                    </asp:DropDownList>
                    <asp:Button ID="Search" runat="server" class="btn" Text="查询" OnClick="Search_Click" />
                        &nbsp;&nbsp; <a href="WorkSummary.aspx"><b style="line-height: 18px; font-size: 14px;">工作总结查询</b></a> &nbsp;&nbsp; <a href="DeptInfo.aspx"><b style="line-height: 18px; font-size: 14px;">部门管理</b></a>
            ...
            <tr>
                <td valign="top" align="center" bgcolor="#f5f5ff">
                                            ...
                                            <asp:Repeater ID="rep" runat="server">
                                                <ItemTemplate>
                                                    <tr align="center">
                                                        ...
                                                        <td>
                                                            <a title="点击查看" style="cursor: pointer;" onclick="viewDetail(<%#Eval("id") %>);">工作计划详情</a>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                    ...
                    <script type="text/javascript">
                        ...
                        var addPlan = function (deptid, month) {
                            var url = "AdminAddPlanInfo.aspx?deptid=" + deptid + "&workmonth=" + month;
