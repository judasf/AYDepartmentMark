...
public partial class Admin_deptinfo : System.Web.UI.Page
{
    ...
    {
        string sql = "select id,deptname from departments where hasSp=1";
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            DirectDataAccessor.Execute("UPDATE departments set loginpwd='123456' where id='" + e.CommandArgument.ToString() + "'");
